<x-app-layout>
    <div class="max-w-2xl mx-auto mt-8 bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <!-- Formulário para cadastrar um novo setor -->
        <form action="{{ route('setores.store') }}" method="POST" class="space-y-6">
            @csrf
            
            <!-- Campo de nome do setor -->
            <div>
                <label for="nome" class="block text-sm font-medium text-gray-300">Nome do Setor:</label>
                <input type="text" name="nome" id="nome" placeholder="Digite o nome do setor" required
